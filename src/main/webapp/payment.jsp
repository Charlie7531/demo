		...
		<section>
			...
			<section>
				<form action="${pageContext.request.contextPath}/thank-you.jsp"
					...
					<div>
						<label>Name on Card</label> <input type="text" name="name_on_card"
							placeholder="Enter Name on Card">
					</div>
					<div>
						<label>Card Number</label> <input type="number"
							name="card_details" placeholder="Enter Card Number">
					</div>
					<br>
					<p>
						<span><strong>Total fare = <br> <%=Booking.ticket_price%>
								X <%=Search.persons%> persons = Rs.<%=  Booking.ticket_price  %>
...
<div class="footer" align="center">FlyAway by shubhamd</div>
</html>
<%
}
%>
